...
public class Task2 {
    ...
    public static void main(String args[]) {
        ...
        for (Catalog.Student o : catalog) {
            ...
            int r = last.mean != o.mean ? new Double(last.mean).compareTo(o.mean) : last.name.compareTo(o.name);
        ...
        if ((catalog.getStudent("Alexandru") == null) || (catalog.getStudent("Alexandru").mean != 7)) {
            System.err.println("Catalog.getStudent() a fost implementata gresit.");
        }
    }
