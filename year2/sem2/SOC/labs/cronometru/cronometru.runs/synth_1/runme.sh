...
HD_PWD='C:/Users/student/Documents/Dumitrache Adrian-George/cronometru/cronometru.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometru.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cronometru.tcl
