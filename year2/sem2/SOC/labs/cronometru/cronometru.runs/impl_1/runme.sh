...
HD_PWD='C:/Users/student/Documents/Dumitrache Adrian-George/cronometru/cronometru.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometru.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cronometru.tcl -notrace
