...
main:
    ...
    ; Rezultatul inmultirii este in DX:AX

    ; shl edx, 16  ; Mutam rezultatul in EAX (doar partea de jos)
    ; mov dx, ax  ; EAX = DX (rezultatul inmultirii)

    PRINTF32 `Produsul numerelor M si N este: %hd%d\n\x0`, edx, eax
